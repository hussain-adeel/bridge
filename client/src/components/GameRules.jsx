    ...
    return (
        <div className="w-full max-h-[70vh] overflow-y-auto overscroll-contain pr-2 pb-8">
            <div className="flex flex-col items-center p-4 md:p-6 text-center text-neutral-300">
                ...
                <ul className="list-decimal list-inside space-y-3 mb-12 text-left max-w-3xl mx-auto bg-neutral-900/60 p-6 rounded-2xl border border-neutral-700/50 shadow-lg">
                ...
                <ul className="space-y-4 mb-4 text-left max-w-3xl mx-auto">
